...
src_install() {
	insinto "/usr/share/php/Symfony/String"
	doins -r AbstractString.php AbstractUnicodeString.php ByteString.php CodePointString.php Exception Inflector LazyString.php Resources Slugger UnicodeString.php autoload.php || die
}
